...
def test_tactile_describe_contract_marks_contact_driven_photon_integration():
    contract = tactile.describe()
    assert contract['schema_version'] == '1.0'
    assert contract['status'] == 'contact_driven_photon_integration'
    ...
    assert contract['contact_backends'] == {'hydroelastic': 'mujoco'}
